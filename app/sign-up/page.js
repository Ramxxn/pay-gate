  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="bg-white p-8 rounded-2xl shadow-md w-[30vw]">
        ...
        <input type="text" placeholder="Full Name" className="w-full mb-3 p-2 rounded-md" />
        <input type="email" placeholder="Email" className="w-full mb-3 p-2 rounded-md" />
        <input type="password" placeholder="Password" className="w-full mb-3 p-2 rounded-md" />
        <input type="password" placeholder="Confirm Password" className="w-full mb-4 p-2 rounded-md" />
